...
class Console:
    ...
    def __format_text(self, text: str):
        return text.replace('->', f'{Fore.LIGHTCYAN_EX}->{Fore.RESET}').replace(':', f'{Fore.YELLOW}:{Fore.RESET}').replace('Error', f'{Fore.RED}Error{Fore.RESET}')
    ...
    def print_success(self, text: str):
        self.__lock_print(self.__format_text(text), '+', Fore.LIGHTGREEN_EX)
    
    def print_info(self, text: str):
        self.__lock_print(self.__format_text(text), '%', Fore.LIGHTYELLOW_EX)